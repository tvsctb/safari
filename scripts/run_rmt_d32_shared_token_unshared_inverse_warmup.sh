...
# Full-length paired warmup screen for the selected natural shared-token/head,
# unshared-inverse RMT recipe at the exact rho/tau anchor.
set -euo pipefail
...
group="${WANDB_GROUP:-rmt-d32-shared-token-unshared-inverse-warmup-20260811-v1}"
suffix="${RUN_SUFFIX:-stuinvwarmup400-v1}"
