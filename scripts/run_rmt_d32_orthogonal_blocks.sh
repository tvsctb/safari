...
group="${WANDB_GROUP:-rmt-d32-orthogonal-blocks-20260720-v1}"
max_epochs="${MAX_EPOCHS:-180}"
steps_per_epoch=157
training_steps="$((steps_per_epoch * max_epochs))"
output_root="${OUTPUT_ROOT:-/tmp/rmt-d32-orthogonal-blocks}"
mkdir -p "$output_root"
...
for seed in 0 1 2 3 4; do
  name="rmt-d32-splitpe-sinusoidal-orthogonal-nodir-seed${seed}-v1"
