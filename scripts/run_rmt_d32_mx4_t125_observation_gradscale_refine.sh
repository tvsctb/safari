...
group="${WANDB_GROUP:-rmt-d32-mx4-t125-observation-gradscale-refine-20260721-v1}"
...
output_root="${OUTPUT_ROOT:-/tmp/rmt-d32-mx4-t125-observation-gradscale-refine}/shard-${shard}"
mkdir -p "$output_root"
...
for seed in "${seeds[@]}"; do
  for scale in 0.85 0.90 0.95; do
    label="${scale/./p}"
    name="rmt-d32-mx4-t125-obsgrad${label}-delay5-s${seed}-refine-v1"
