...
group="${WANDB_GROUP:-rmt-d32-mx4-t125-floor03-extend-20260721-v1}"
max_epochs="${MAX_EPOCHS:-240}"
steps_per_epoch=157
training_steps="$((steps_per_epoch * max_epochs))"
warmup_steps="$((training_steps / 10))"
output_root="${OUTPUT_ROOT:-/tmp/rmt-d32-mx4-t125-floor03-extend}"
mkdir -p "$output_root"
...
names=()
for seed in 3 4; do
  name="rmt-d32-mx4-t125-floor0p3-s${seed}-auxfloor-extend-v1"
